...
func AguaclaraKeeper(t testing.TB) (*keeper.Keeper, sdk.Context) {
	...
	IBCKeeper := ibckeeper.NewKeeper(
		...
		nil,
		nil,
		capabilityKeeper.ScopeToModule("AguaclaraIBCKeeper"),
	)
	...
	k := keeper.NewKeeper(
		...
		capabilityKeeper.ScopeToModule("AguaclaraScopedKeeper"),
	)
