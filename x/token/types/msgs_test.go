...
func TestMsgEditTokenGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"ancon-protocol/token/MsgEditToken","value":{"max_supply":"21000000","mintable":"false","name":"BTC TOKEN","owner":"cosmos1fsgzj6t7udv8zhf6zj32mkqhcjcpv52ygswxa5","symbol":"btc"}}`
