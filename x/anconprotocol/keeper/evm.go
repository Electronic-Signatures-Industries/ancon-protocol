...
func init() {
	CreateMetadataAbiEvent()
	SendCrossmintRequestAbiEvent()
}
...
func CreateMetadataAbi() abi.ABI {
	...
	event["__CosmosNativeCreateMetadata"] = CreateMetadata
...
func SendCrossmintRequestAbiEvent() {
	...
	//bytesType, _ := abi.NewType("bytes", "", nil)
	stringType, _ := abi.NewType("string", "", nil)
	SendCrossmintRequest = abi.NewEvent(
		"__CosmosNativeSendCrossmintRequest",
		"__CosmosNativeSendCrossmintRequest",
		false,
		abi.Arguments{abi.Argument{
...
func SendCrossmintRequestAbi() abi.ABI {
	event := make(map[string]abi.Event)
	event["__CosmosNativeSendCrossmintRequest"] = SendCrossmintRequest
