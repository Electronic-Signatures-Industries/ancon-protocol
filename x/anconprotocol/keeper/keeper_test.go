...
func Test_Convert_From_Base64_To_Bytes(t *testing.T) {
	data := ""
	...
	//json.Unmarshal(ethToHex, &payload)
	...
	// signdoc marshal
	sdkToHex, _ := hex.DecodeString(string(sdkPayload))
	var signDoc txtypes.TxRaw
	t, err := sdk.TxDecoder(sdkPayload)
	json.Unmarshal(sdkToHex, &signDoc)
