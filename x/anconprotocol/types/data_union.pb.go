...
type DataSource struct {
	...
	DidOwner    string   `protobuf:"bytes,2,opt,name=did_owner,json=didOwner,proto3" json:"did_owner,omitempty"`
...
func (m *DataSource) GetDidOwner() string {
	if m != nil {
		return m.DidOwner
	}
	return ""
...
func (m *DataUnion) GetDid() string {
	if m != nil {
		return m.Did
	}
	return ""
...
type Anchor struct {
	DidOwner  string `protobuf:"bytes,1,opt,name=did_owner,json=didOwner,proto3" json:"did_owner,omitempty"`
...
func (m *Anchor) GetDidOwner() string {
	if m != nil {
		return m.DidOwner
	}
	return ""
...
func (m *Pricing) GetDidOwner() string {
	if m != nil {
		return m.DidOwner
	}
	return ""
...
var fileDescriptor_2c5127372209c222 = []byte{
	...
	,
}
...
func (m *DataSource) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DidOwner) > 0 {
		...
		i = encodeVarintDataUnion(dAtA, i, uint64(len(m.DidOwner)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *DataUnion) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Did) > 0 {
		i -= len(m.Did)
		copy(dAtA[i:], m.Did)
		i = encodeVarintDataUnion(dAtA, i, uint64(len(m.Did)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Name) > 0 {
