...
const basePool: object = { id: 0, typeId: 0, reserveCoinDenoms: '', reserveAccountAddress: '', poolCoinDenom: '' }
...
const basePoolBatch: object = { poolId: 0, index: 0, beginHeight: 0, depositMsgIndex: 0, withdrawMsgIndex: 0, swapMsgIndex: 0, executed: false }
...
const baseDepositMsgState: object = { msgHeight: 0, msgIndex: 0, executed: false, succeeded: false, toBeDeleted: false }
...
const baseWithdrawMsgState: object = { msgHeight: 0, msgIndex: 0, executed: false, succeeded: false, toBeDeleted: false }
...
const baseSwapMsgState: object = { msgHeight: 0, msgIndex: 0, executed: false, succeeded: false, toBeDeleted: false, orderExpiryHeight: 0 }
