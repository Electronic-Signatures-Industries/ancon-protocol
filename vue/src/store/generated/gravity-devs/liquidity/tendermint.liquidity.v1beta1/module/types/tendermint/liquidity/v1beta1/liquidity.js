...
const basePoolType = { id: 0, name: '', minReserveCoinNum: 0, maxReserveCoinNum: 0, description: '' };
...
const basePool = { id: 0, typeId: 0, reserveCoinDenoms: '', reserveAccountAddress: '', poolCoinDenom: '' };
export const Pool = {
    encode(message, writer = Writer.create()) {
        if (message.id !== 0) {
...
const basePoolBatch = { poolId: 0, index: 0, beginHeight: 0, depositMsgIndex: 0, withdrawMsgIndex: 0, swapMsgIndex: 0, executed: false };
export const PoolBatch = {
    ...
    toJSON(message) {
        ...
        message.beginHeight !== undefined && (obj.beginHeight = message.beginHeight);
        message.depositMsgIndex !== undefined && (obj.depositMsgIndex = message.depositMsgIndex);
        message.withdrawMsgIndex !== undefined && (obj.withdrawMsgIndex = message.withdrawMsgIndex);
        message.swapMsgIndex !== undefined && (obj.swapMsgIndex = message.swapMsgIndex);
...
const baseDepositMsgState = { msgHeight: 0, msgIndex: 0, executed: false, succeeded: false, toBeDeleted: false };
...
const baseWithdrawMsgState = { msgHeight: 0, msgIndex: 0, executed: false, succeeded: false, toBeDeleted: false };
...
const baseSwapMsgState = { msgHeight: 0, msgIndex: 0, executed: false, succeeded: false, toBeDeleted: false, orderExpiryHeight: 0 };
export const SwapMsgState = {
    ...
    toJSON(message) {
        ...
        message.succeeded !== undefined && (obj.succeeded = message.succeeded);
        message.toBeDeleted !== undefined && (obj.toBeDeleted = message.toBeDeleted);
        message.orderExpiryHeight !== undefined && (obj.orderExpiryHeight = message.orderExpiryHeight);
