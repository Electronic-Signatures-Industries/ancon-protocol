...
const baseSwagger: object = { swagger: '', host: '', basePath: '', schemes: 0, consumes: '', produces: '' }
...
export const Swagger = {
  ...
  toJSON(message: Swagger): unknown {
    ...
    message.securityDefinitions !== undefined &&
      (obj.securityDefinitions = message.securityDefinitions ? SecurityDefinitions.toJSON(message.securityDefinitions) : undefined)
    if (message.security) {
      obj.security = message.security.map((e) => (e ? SecurityRequirement.toJSON(e) : undefined))
    } else {
      obj.security = []
    }
    message.externalDocs !== undefined && (obj.externalDocs = message.externalDocs ? ExternalDocumentation.toJSON(message.externalDocs) : undefined)
    obj.extensions = {}
...
export const Swagger_ResponsesEntry = {
  encode(message: Swagger_ResponsesEntry, writer: Writer = Writer.create()): Writer {
    if (message.key !== '') {
...
export const Swagger_ExtensionsEntry = {
  encode(message: Swagger_ExtensionsEntry, writer: Writer = Writer.create()): Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
    }
    if (message.value !== undefined) {
  ...
  decode(input: Reader | Uint8Array, length?: number): Swagger_ExtensionsEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseSwagger_ExtensionsEntry } as Swagger_ExtensionsEntry
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
const baseOperation: object = { tags: '', summary: '', description: '', operationId: '', consumes: '', produces: '', schemes: 0, deprecated: false }
...
export const Operation_ResponsesEntry = {
  encode(message: Operation_ResponsesEntry, writer: Writer = Writer.create()): Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
    }
    if (message.value !== undefined) {
  ...
  decode(input: Reader | Uint8Array, length?: number): Operation_ResponsesEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseOperation_ResponsesEntry } as Operation_ResponsesEntry
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
export const Operation_ExtensionsEntry = {
  encode(message: Operation_ExtensionsEntry, writer: Writer = Writer.create()): Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
    }
    if (message.value !== undefined) {
  ...
  decode(input: Reader | Uint8Array, length?: number): Operation_ExtensionsEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseOperation_ExtensionsEntry } as Operation_ExtensionsEntry
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
const baseHeader: object = { description: '', type: '', format: '', default: '', pattern: '' }
...
export const Response_HeadersEntry = {
  encode(message: Response_HeadersEntry, writer: Writer = Writer.create()): Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
    }
    if (message.value !== undefined) {
...
export const Response_ExamplesEntry = {
  encode(message: Response_ExamplesEntry, writer: Writer = Writer.create()): Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
    }
    if (message.value !== '') {
...
export const Response_ExtensionsEntry = {
  encode(message: Response_ExtensionsEntry, writer: Writer = Writer.create()): Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
    }
    if (message.value !== undefined) {
  ...
  decode(input: Reader | Uint8Array, length?: number): Response_ExtensionsEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseResponse_ExtensionsEntry } as Response_ExtensionsEntry
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
const baseInfo: object = { title: '', description: '', termsOfService: '', version: '' }
...
export const Info_ExtensionsEntry = {
  encode(message: Info_ExtensionsEntry, writer: Writer = Writer.create()): Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
    }
    if (message.value !== undefined) {
...
export const ExternalDocumentation = {
  encode(message: ExternalDocumentation, writer: Writer = Writer.create()): Writer {
    if (message.description !== '') {
      writer.uint32(10).string(message.description)
    }
    if (message.url !== '') {
...
export const Schema = {
  ...
  toJSON(message: Schema): unknown {
    const obj: any = {}
    message.jsonSchema !== undefined && (obj.jsonSchema = message.jsonSchema ? JSONSchema.toJSON(message.jsonSchema) : undefined)
...
export const SecurityDefinitions = {
  encode(message: SecurityDefinitions, writer: Writer = Writer.create()): Writer {
...
export const SecurityDefinitions_SecurityEntry = {
  encode(message: SecurityDefinitions_SecurityEntry, writer: Writer = Writer.create()): Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
    }
    if (message.value !== undefined) {
  ...
  decode(input: Reader | Uint8Array, length?: number): SecurityDefinitions_SecurityEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseSecurityDefinitions_SecurityEntry } as SecurityDefinitions_SecurityEntry
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
const baseSecurityScheme: object = { type: 0, description: '', name: '', in: 0, flow: 0, authorizationUrl: '', tokenUrl: '' }
...
export const SecurityScheme_ExtensionsEntry = {
  encode(message: SecurityScheme_ExtensionsEntry, writer: Writer = Writer.create()): Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
    }
    if (message.value !== undefined) {
  ...
  decode(input: Reader | Uint8Array, length?: number): SecurityScheme_ExtensionsEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseSecurityScheme_ExtensionsEntry } as SecurityScheme_ExtensionsEntry
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
export const SecurityRequirement = {
  encode(message: SecurityRequirement, writer: Writer = Writer.create()): Writer {
    Object.entries(message.securityRequirement).forEach(([key, value]) => {
      SecurityRequirement_SecurityRequirementEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).ldelim()
    })
    return writer
  },
...
export const SecurityRequirement_SecurityRequirementValue = {
  encode(message: SecurityRequirement_SecurityRequirementValue, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): SecurityRequirement_SecurityRequirementValue {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseSecurityRequirement_SecurityRequirementValue } as SecurityRequirement_SecurityRequirementValue
    message.scope = []
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
...
export const SecurityRequirement_SecurityRequirementEntry = {
  encode(message: SecurityRequirement_SecurityRequirementEntry, writer: Writer = Writer.create()): Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
    }
    if (message.value !== undefined) {
  ...
  decode(input: Reader | Uint8Array, length?: number): SecurityRequirement_SecurityRequirementEntry {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseSecurityRequirement_SecurityRequirementEntry } as SecurityRequirement_SecurityRequirementEntry
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: SecurityRequirement_SecurityRequirementEntry): unknown {
    const obj: any = {}
    message.key !== undefined && (obj.key = message.key)
    message.value !== undefined && (obj.value = message.value ? SecurityRequirement_SecurityRequirementValue.toJSON(message.value) : undefined)
    return obj
  },
