...
const baseSwagger = { swagger: '', host: '', basePath: '', schemes: 0, consumes: '', produces: '' };
...
export const Swagger_ExtensionsEntry = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseSwagger_ExtensionsEntry };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseOperation = { tags: '', summary: '', description: '', operationId: '', consumes: '', produces: '', schemes: 0, deprecated: false };
...
export const Operation_ResponsesEntry = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseOperation_ResponsesEntry };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const Operation_ExtensionsEntry = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseOperation_ExtensionsEntry };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseHeader = { description: '', type: '', format: '', default: '', pattern: '' };
export const Header = {
    encode(message, writer = Writer.create()) {
        if (message.description !== '') {
...
const baseInfo = { title: '', description: '', termsOfService: '', version: '' };
export const Info = {
    encode(message, writer = Writer.create()) {
        if (message.title !== '') {
...
const baseSecurityScheme = { type: 0, description: '', name: '', in: 0, flow: 0, authorizationUrl: '', tokenUrl: '' };
...
export const SecurityScheme_ExtensionsEntry = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseSecurityScheme_ExtensionsEntry };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const SecurityRequirement_SecurityRequirementValue = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseSecurityRequirement_SecurityRequirementValue };
        message.scope = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
