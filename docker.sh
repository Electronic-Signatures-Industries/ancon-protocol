...
ancon-protocold config keyring-backend $KEYRING  --home ~/.ancon-protocold
ancon-protocold config chain-id $CHAINID  --home ~/.ancon-protocold

# if $KEY exists it should be deleted
(echo $MNEMONICA) | ancon-protocold keys add $KEY --keyring-backend $KEYRING --algo $KEYALGO --recover  --home ~/.ancon-protocold

#(echo $MNEMONICA)| ancon-protocold keys add alice --keyring-backend $KEYRING --algo $KEYALGO --recover
#(echo $MNEMONICB)| ancon-protocold keys add bob --keyring-backend $KEYRING --algo $KEYALGO --recover
...
ancon-protocold validate-genesis  --home ~/.ancon-protocold
...
#ancon-protocold keys show alice | echo
#ancon-protocold keys show bob | echo
